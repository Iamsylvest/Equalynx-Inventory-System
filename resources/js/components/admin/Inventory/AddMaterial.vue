<template>
    <div>
      ...
      <button @click="showModal" class="px-4 py-2 rounded-lg flex items-center justify-center font-semibold bg-custom-blue text-white drop-shadow-md whitespace-nowrap">
      ...
      <!-- Modal -->
      <div v-if="addMaterial" class="fixed inset-0 bg-gray-800 bg-opacity-50 z-50 flex items-center justify-center">
        <!-- Modal Content -->
