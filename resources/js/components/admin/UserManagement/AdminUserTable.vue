    ...
    <table class="table-auto w-full border-collapse mt-1 shadow-lg">
        ...
        >
          ...
          <td class="px-4 py-4 text-center">
            <span
              ...
              :class="{
                  'bg-green-300 text-green-600 dark:bg-green-700 dark:text-green-300': user.role === 'admin',
                  'bg-orange-300 text-orange-600 dark:bg-orange-700 dark:text-orange-300': user.role === 'manager',
                  'bg-red-300 text-red-600 dark:bg-red-700 dark:text-red-300': user.role === 'procurement',
                  'bg-yellow-300 text-yellow-600 dark:bg-yellow-700 dark:text-yellow-300': user.role === 'warehouse_staff'
                }"
            >
              {{ user.role }}
            </span>
          ...
          <td class="text-center px-4 py-2 border-0 md:space-x-3">
            <button class="text-gray-500 hover:underline w-full md:w-auto  dark:text-custom-white" @click="showEditModal(user)">
              ...
              <button @click="deleteUser(user.id)" class="text-gray-500 hover:underline w-full lg:w-auto  dark:text-custom-white ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <div class="flex items-center justify-center py-2 px-4 bg-white shadow-md z-50 dark:bg-custom-table">
              ...
              <button 
                ...
                class="text-lg px-4 py-2 rounded-lg disabled:opacity-2 hover:bg-gray-100 dark:hover:bg-custom-hover cursor-pointer"
              >
                ←
              </button>
              ...
              <span 
                ...
                :class="{'bg-blue-500 dark:bg-custom-table text-white': currentPage === page, 'hover:bg-gray-200': currentPage !== page}"
              >
                {{ page }}
              </span>
