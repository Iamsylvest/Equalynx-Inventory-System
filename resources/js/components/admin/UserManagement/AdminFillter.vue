  ...
  <div class="md:flex md:items-center gap-4 ">
    ...
    <div class="flex items-center gap-2">
      <input
        ...
        class="dark:bg-custom-table border dark:focus:ring-white border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 w-[250px] md:w-[148px]"
      />
