          ...
          <tbody>
                    ...
                    <tr v-for="(dr, index) in drs" :key="index" class="bg-gray-200 border-b hover:bg-white">
                        ...
                        <span 
                            ...
                            :class="{
                            'bg-green-300 text-green-600': dr.status === 'approved',
                            'bg-red-300 text-red-600': dr.status === 'rejected',
                            'bg-yellow-300 text-yellow-600': dr.status === 'pending'
                            }"
                        >
                            {{ dr.status }}
                        </span>
                        ...
                        <td class="text-center px-4 py-2 border-0 space-x-4 flex item-center justify-center mt-2">
                            <button  @click="restoreDr(dr.id, dr.dr_number)"  class="text-gray-500 hover:underline">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
                                </svg>
                            </button>

                            <button  @click="deleteDr(dr.id, dr.dr_number)"  class="text-gray-500 hover:underline">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
