            ...
            <div class="bg-gray-100 p-6 rounded-md shadow-lg  dark:bg-custom-table">
              ...
              <div class="space-y-6">
                <div>
                  ...
                  <input id="location" v-model="formData.location" type="text" class="dark:bg-custom-table dark:focus:ring-white w-full p-2 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-300">
                </div>
                <div class="flex justify-between">
                  <div class="w-1/2 pr-3">
                    <label for="latitude" class="text-sm text-gray-600  dark:text-custom-white">Latitude:</label>
                    <input id="latitude" v-model="formData.latitude" type="number" step="any" class="dark:bg-custom-table dark:focus:ring-white w-full p-2 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-300">
                  </div>
                  <div class="w-1/2 pl-3">
                    <label for="longitude" class="text-sm text-gray-600  dark:text-custom-white">Longitude:</label>
                    <input id="longitude" v-model="formData.longitude" type="number" step="any" class="dark:bg-custom-table dark:focus:ring-white w-full p-2 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-300">
                  </div>
                </div>
