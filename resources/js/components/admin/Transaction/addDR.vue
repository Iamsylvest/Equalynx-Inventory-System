              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <select 
                          ...
                          :disabled="true" 
                           class="w-full p-2 text-xs border border-gray-300 rounded-md bg-gray-100 text-gray-600 focus:ring-2 focus:ring-blue-300"
                        >
              ...
              <div class="space-y-6">
                ...
                <div v-for="(material, index) in formData.materials" :key="index" class="flex space-x-6">
                  ...
                  <div class="flex-1">
                    ...
                    <input :id="'measurement_' + index" v-model="material.measurement"  placeholder="Enter unit (e.g., 24 meters, 10 kg)" class="w-full p-2 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-300">
                  </div>
                  <div class="flex-1">
                    <label :for="'unit' + index" class="text-sm text-gray-600">Unit:</label>
                        <select 
                          ...
                          placeholder="Enter unit (e.g., 24 meters, 10 kg)" class="w-full p-2 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-300"
                        >
