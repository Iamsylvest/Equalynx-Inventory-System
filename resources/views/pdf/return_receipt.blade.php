...
<body>
    ...
    <table class="no-border" style="margin-bottom: 20px;">
        <tr>
            ...
            <td style="width: 40%; text-align: left; vertical-align: middle;">
                <h1 style="font-size: 40px; font-weight: bold;">Return Receipt</h1>
            </td>
        </tr>
    </table>
    ...
    <table class="no-border" style="font-size: 16px; margin-bottom: 20px;">
        <tr>
            <td style="width: 60%; vertical-align: top;">
                <p><strong>Date:</strong> {{ \Carbon\Carbon::parse($rr->created_at)->format('F j, Y') }}</p>
                <p><strong>Project Name:</strong> {{ $rr->project_name }}</p>
            </td>
            <td style="width: 40%; vertical-align: top;">
                <p><strong>RR#:</strong> {{ $rr->rr_number }}</p>
                <p><strong>Location:</strong> {{ $rr->location }}</p>
            </td>
        </tr>
    </table>
    ...
    <table class="bordered-table">
        ...
        <tbody>
            @foreach($rr->materials as $material)
            <tr>
